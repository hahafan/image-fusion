function[im_blend]=mixedBlend(im_s,im_s2, mask_s, im_bg)
    ...
    for x=2:imw-1
        if mask_s(im2var(y,x))
            %与上领域差值
               ...
               d=max((im_s(y,x,:)-im_s(y-1,x,:)),(im_s2(y,x,:)-im_s2(y-1,x,:)),(im_bg(y,x,:)-im_bg(y-1,x,:)));
          ...
          %     d=max((im_s(y,x,:)-im_s(y-1,x,:)),(im_bg(y,x,:)-im_bg(y-1,x,:))); 
            ...
            d=max((im_s(y,x,:)-im_s(y,x-1,:)),(im_s2(y,x,:)-im_s2(y,x-1,:)),(im_bg(y,x,:)-im_bg(y,x-1,:)));
